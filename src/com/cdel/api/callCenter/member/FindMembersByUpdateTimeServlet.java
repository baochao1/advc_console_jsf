...
public class FindMembersByUpdateTimeServlet extends HttpServlet {

	protected static Logger logger = Logger.getLogger(FindMembersByUpdateTimeServlet.class);
	...
	protected void doPost(HttpServletRequest request,
		...
		if (str.equals("1")) {
			...
			try {
				members = memberFacade.findMembersByUpdateTime(member);
